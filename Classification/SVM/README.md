...
*arg: Arg have two input types- LINEAR, POLY and RBF (Default) for linear function, polynomial function and radial basis function respectively. It must be given as list or a string. **’linear’** , **’poly’** and **‘rbf’** respectively.
